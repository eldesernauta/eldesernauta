...
const HorizontalScrollCarousel = () => {
    ...
    return (
        <section ref={targetRef} className="relative h-[600vh] md:h-[400vh] ">
            <div className="container mb-32 mt-24 flex flex-col items-start justify-end mx-auto">
                <h2 className='font-Unbounded font-black text-8xl text-light flex mb-8'>We provide world</h2>
                <h2 className='font-Unbounded font-black text-8xl text-light flex'>class<span className='px-8 py-4 text-8xl text-dark bg-warning hover:bg-accent font-black transition-all duration-300 rounded-full border-2 border-light -mx-4 -rotate-12'>services</span>for you</h2>
    ...
    return (
        <div className="flex gap-4 items-stretch">
            ...
            <section className="w-full relative mt-8 2xl:mt-12 px-0 flex flex-col gap-0">
                ...
                />
                <div className="flex z-10 min-h-[400px] sm:min-h-[600px] md:min-h-[800px] lg:min-h-[450px] 2xl:min-h-[600px] min-w-[80vw] md:min-w-[40vw] rounded-xl shadow-dark items-between justify-start gap-20 mx-auto border-2 border-dark hover:bg-light-purple-goo hover:text-white p-5 group">
