...
function BaseMarquee({ children, baseVelocity = 100 }) {
  ...
  return (
    <div className="parallax py-8 w-full max-w-full flex items-center justify-center overflow-hidden">
      <motion.div className="font-Adam font-medium text-5xl m-0 text-dark flex items-center justify-center whitespace-nowrap flex-nowrap gap-96 select-none" style={{ x }}>
