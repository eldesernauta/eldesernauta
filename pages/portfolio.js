...
const Portfolio = () => {
    return (
        <Layout>
            ...
            <div
                className="w-screen relative bg-light flex justify-start items-center flex-col bg-[linear-gradient(to_right,#80808010_1px,transparent_1px),linear-gradient(to_bottom,#80808010_1px,transparent_1px)] bg-[size:50px_50px]"
            >
